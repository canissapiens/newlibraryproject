...
INSERT INTO `author` (`id_author`, `last_name`, `first_name`, `birth_place`) VALUES (5, 'Szmaglewska', 'Seweryna', 'Przygądów');
...
INSERT INTO `book` (`id_book`, `borrow`, `category`, `isbn`, `pages`, `release_date`, `summary`, `title`, `author_id`) 
VALUES (3, b'0', 'intryga', '9876655678373', 334, 1500, 'trupy panie', 'Hamlet', 1);
...
INSERT INTO `book` (`id_book`, `borrow`, `category`, `isbn`, `pages`, `release_date`, `summary`, `title`, `author_id`) VALUES (1, b'0', 'powieść', '2223336789838', 222, 1955, 'jcprdl', 'Dolina Issy', 4);
...
INSERT INTO `book` (`id_book`, `borrow`, `category`, `isbn`, `pages`, `release_date`, `summary`, `title`, `author_id`) VALUES (8, b'0', 'kryminaĹ‚', '4545532535514', 198, 1964, 'strach się bać', 'Wyspa złoczyńców', 8);
...
INSERT INTO `borrower` (`id_borrower`, `first_name`, `last_name`, `borrower_details_id`) VALUES (1, 'Robert', 'Nowak', 1);
INSERT INTO `borrower` (`id_borrower`, `first_name`, `last_name`, `borrower_details_id`) VALUES (2, 'Paweł', 'Gaweł', 2);
INSERT INTO `borrower` (`id_borrower`, `first_name`, `last_name`, `borrower_details_id`) VALUES (3, 'Janusz', 'Cisak', 3);
INSERT INTO `borrower` (`id_borrower`, `first_name`, `last_name`, `borrower_details_id`) VALUES (4, 'Tomasz', 'Wilmowski', 4);
INSERT INTO `borrower` (`id_borrower`, `first_name`, `last_name`, `borrower_details_id`) VALUES (5, 'Felicjan', 'Dulski', 5);
INSERT INTO `borrower` (`id_borrower`, `first_name`, `last_name`, `borrower_details_id`) VALUES (6, 'Roman', 'Wolski', 6);
INSERT INTO `borrower` (`id_borrower`, `first_name`, `last_name`, `borrower_details_id`) VALUES (7, 'Witold', 'Szczygieł', 7);

INSERT INTO `borrower_details` (`id_borrower_details`, `address`, `email`, `phone`) VALUES (1, 'Kraków', 'robert@foo.com', '5315');
INSERT INTO `borrower_details` (`id_borrower_details`, `address`, `email`, `phone`) VALUES (2, 'Pcim', 'pawel@foo.com', '7212');
INSERT INTO `borrower_details` (`id_borrower_details`, `address`, `email`, `phone`) VALUES (3, 'Tarnów', 'janusz@foo.com', '4567');
INSERT INTO `borrower_details` (`id_borrower_details`, `address`, `email`, `phone`) VALUES (4, 'Sydney', 'tomek@foo.com', '8354');
INSERT INTO `borrower_details` (`id_borrower_details`, `address`, `email`, `phone`) VALUES (5, 'Poznań', 'felek@foo.com', '8354');
INSERT INTO `borrower_details` (`id_borrower_details`, `address`, `email`, `phone`) VALUES (6, 'Dzierżążno', 'romek@foo.com', '8354');
INSERT INTO `borrower_details` (`id_borrower_details`, `address`, `email`, `phone`) VALUES (7, 'Myślenice', 'witek@foo.com', '8354');
